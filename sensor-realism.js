...
<svg viewBox="0 0 1120 540" role="img" aria-label="Patent-grounded conceptual cutaway of the mesh-type acoustic vector sensor and optical displacement readout">
  ...
  <g transform="translate(525 278)">
    ...
    <g class="eng-callout-card" transform="translate(-82 -156)">
      <rect x="-12" y="-18" width="188" height="38" rx="4"/>
      <text x="82" y="5" class="eng-small" text-anchor="middle">MICROFABRICATED SUPPORT FRAME</text>
    </g>
    <line x1="0" y1="-122" x2="0" y2="-104" class="callout"/>

    <g id="engMesh" class="mesh-flex" transform="scale(1 .76)">
      ${rings}${spokes}
      <circle class="mesh-highlight" cx="0" cy="0" r="105"/>
    ...
    <g class="eng-callout-card" transform="translate(-324 -91)">
      ...
      <text x="12" y="21" class="eng-label">FINE 2-D WEB</text>
    ...
    <g class="eng-callout-card" transform="translate(176 55)">
      ...
      <text x="14" y="23" class="eng-label">NORMAL DISPLACEMENT</text>
    ...
    <line x1="150" y1="133" x2="150" y2="151" class="dimension"/>
    <rect x="-46" y="128" width="92" height="28" rx="4" class="eng-inline-card"/>
  ...
  <g class="probe-glow" transform="translate(842 230)">
    ...
    <circle cx="22" cy="46" r="3.2" fill="#e2e5de"/>
    <text x="118" y="38" class="eng-label" text-anchor="middle">OPTICAL PROBE</text>
    <text x="118" y="61" class="eng-small" text-anchor="middle">mirror displacement readout</text>
    <line id="engLaser" x1="22" y1="46" x2="-210" y2="48" class="laser"/>
  ...
  <g transform="translate(822 354)">
    ...
    <text x="125" y="31" class="eng-label" text-anchor="middle">SIGNAL PROCESSING</text>
  ...
  <g transform="translate(402 468)">
    ...
    <text x="123" y="25" class="eng-small" text-anchor="middle">FLOATING / MOORED EMBODIMENT</text>
  </g>
</svg>
...
function update(){
  ...
  if(point){point.setAttribute('cy',String(px));point.setAttribute('r',String(3+proj));}
  if(halo){halo.setAttribute('cy',String(px));halo.setAttribute('ry',String(18+proj*4));halo.setAttribute('opacity',String(.18+proj*.28));}
...
['freq','spl','diameter','spacing'].forEach(id=>document.getElementById(id)?.addEventListener('input',()=>queueMicrotask(update)));
update();
})();