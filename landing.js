...
[
  ...
  ['hero-polish.css','hero-polish.css?v=2'],
  ['hero-media.css','hero-media.css?v=1'],
  ['sensor-realism.css','sensor-realism.css?v=2'],
  ['formula-layout.css','formula-layout.css?v=1'],
  ['patent-accuracy.css','patent-accuracy.css?v=1']
].forEach(([key,href])=>{
...
const loadHeroMedia=()=>import('./hero-media.js?v=1').catch(err=>console.warn('RHKEARTH cover media fallback:',err));
const loadHeroPolish=()=>import('./hero-polish.js?v=2').catch(err=>console.warn('RHKEARTH cover polish fallback:',err));
const loadSensor=()=>import('./sensor-realism.js?v=2').catch(err=>console.warn('RHKEARTH sensor cutaway fallback:',err));
const loadPatentAccuracy=()=>import('./patent-accuracy.js?v=1').catch(err=>console.warn('RHKEARTH patent-accuracy layer fallback:',err));
const load3D=()=>import('./mission3d.js?v=2').catch(err=>console.warn('RHKEARTH 3D demonstrator fallback:',err));
function loadEnhancements(){loadHeroMedia();loadHeroPolish();loadSensor().then(loadPatentAccuracy);load3D();}
