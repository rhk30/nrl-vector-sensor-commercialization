...
[
  ...
  ['hero-media.css','hero-media.css?v=7'],
  ...
  ['patent-strict.css','patent-strict.css?v=4']
...
const loadTechnologyUnified=()=>import('./technology-unified.js?v=7').catch(err=>console.warn('RHKEARTH unified technology exhibit fallback:',err));
