...
bridge.innerHTML=`
  <div class="teb-copy">
    <span>PATENT-REPORTED PROTOTYPE GEOMETRY // US11287508B2</span>
    <p>The cutaway above shows the sensing mechanism. The graph below isolates the patent-described normalized cosine directivity relative to the mesh normal.</p>
  </div>
  <div class="teb-stats" aria-label="Patent-reported prototype geometry">
    <div><span>Prototype OD</span><b>6 mm</b></div>
    <div><span>Filament separation</span><b>20 μm</b></div>
