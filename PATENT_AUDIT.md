...
### A. Patent-reported prototype evidence
...
### B. Patent estimates / projections

These may be shown only when explicitly labeled estimate, projected, or equivalent.

- Interferometer noise floor of approximately 2 pm/√Hz used in the patent MDP estimate.
- Estimated minimum detectable sound pressure in air of approximately 100 μPa.
- Projected equivalent water pressure spectral density of approximately 76 dB re 1 μPa/√Hz.
- Floating-base size estimate of approximately 10 mm radius for 10 Hz operation.
- FIG. 4 condition of 100 μPa air pressure corresponding to 0.24 μm/s flow velocity.

Required wording rule: the 76 dB value is not an in-water validation result and must never be presented as demonstrated underwater performance.
...
- a tower moored above an anchor;
- optional tower power, memory, transmitter, and surface recovery / transmission of stored information.

Required wording rule: use “patent-described,” “the specification describes,” or “an embodiment contemplates” unless a specific prototype measurement is being discussed.
...
- contact alerts;
- assumed detection envelopes or range rings;
...
The website may visualize mathematical relationships expressly stated in the patent, provided they are not presented as measured data.

Allowed:

- normalized signed directivity: R/Rmax = cos θ;
- ideal square-mesh fiber-length relation: 2L²/d;
- ideal square-mesh fiber-length gain relative to one cantilever: 2L/d.
...
- the cosine curve is an analytical relationship stated in the patent; the site must not invent measured points that are not tabulated in the patent;
- negative cosine response denotes dipole polarity / phase reversal, not negative sensitivity.

## Visualization policy

The public demonstrators may show source bearing, direction arrows, wavefronts, deployment geometry, and patent architecture relationships.
...
Any distance control must be labeled as normalized scene spacing or visual separation, not sensor range.
