...
// Keep the summary metrics anchored to patent-reported values.
  ...
  boundary.innerHTML=`
    <div class="patent-boundary-col patent-facts">
      ...
      <div class="patent-fact-grid">
        ...
        <div><b>≈20 μm</b><span>released-web beam separation reported for the prototype</span></div>
        ...
        <div><b>≈76 dB re 1 μPa/√Hz</b><span>equivalent water MDP projected in the patent; not an in-water validation result</span></div>
      </div>
    </div>
    <div class="patent-boundary-col model-boundary">
      <div class="patent-boundary-kicker">VISUALIZATION BOUNDARY</div>
      <p>Interactive elements show normalized directional response, source bearing and deployment geometry only. They do not calculate or claim NRL detection range, sonar SNR, bearing accuracy, platform performance or operational capability.</p>
      <p>Mesh displacement and acoustic wavefront motion are visually exaggerated so the disclosed operating principle is legible.</p>
...
// Patent-grounded architecture descriptions.
const modeCopy={
  ...
  tower:['Tower-with-channels embodiment','Tower 504 contains channels 506 filled with viscous liquid, with flow sensors positioned in channel cavities. Multiple channels may have different orientations; disclosed embodiments include buoyancy control, power, memory, transmission and detachable surface recovery.'],
