...
// Patent-described nodes are passive sensing/measurement elements in this visualization.
// Wavefront rings belong only to acoustic-source context, not to the node itself.
const node=(x,y,s=1)=>`<g class="rhk-node" transform="translate(${x} ${y}) scale(${s})"><circle class="rhk-node-base" r="19"/><circle class="rhk-node-hub" r="4"/><rect class="rhk-meter" x="-5" y="-37" width="10" height="15" rx="1"/><rect class="rhk-meter" x="-5" y="22" width="10" height="15" rx="1"/><rect class="rhk-meter" x="-37" y="-5" width="15" height="10" rx="1"/><rect class="rhk-meter" x="22" y="-5" width="15" height="10" rx="1"/><line class="rhk-tether" x1="0" y1="19" x2="0" y2="72"/><path class="rhk-anchor" d="M-18 72H18L25 84H-25Z"/></g>`;
